  ...
  return (
    <section className="flex flex-col items-center text-center relative bg-none px-6 py-30 md:py-50 text-white overflow-hidden ">
      ...
      <div className="absolute inset-0 ">
        <LiquidEther colors={["#87B59B", "#CBFCDE", "#CBFCDE"]} />
      </div>

      {/* Content INSIDE orb */}

      {/* Badge */}
      <span className="mb-8 inline-flex items-center gap-2 rounded-full bg-[#002113]/90 px-4 py-1 text-sm backdrop-blur">
        ⦿ Digital Heroes
      </span>
      ...
      <div className='flex flex-row justify-center items-center gap-4 w-full mt-8 z-10'>
        ...
        <Button
          className='relative bg-[#002113]/90  overflow-hidden'
          onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
        >
          Contact Us
          <BorderBeam duration={8} size={100} className="from-transparent via-green-500 to-transparent" reverse />
        </Button>
